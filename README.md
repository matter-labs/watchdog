...
- `FLOW_DEPOSIT_MIN_PRIORITY_FEE_GWEI` -- minimum L1 `maxPriorityFeePerGas` to use for
...
- `FLOW_DEPOSIT_L2_TIMEOUT`, `MAX_LOGS_BLOCKS`, `FLOW_DEPOSIT_RETRY_INTERVAL`,
  ...
  `FLOW_DEPOSIT_MIN_PRIORITY_FEE_GWEI` shared with deposit flow
